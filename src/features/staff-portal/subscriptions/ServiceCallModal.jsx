...
const ServiceCallModal = ({ isOpen, onClose, serviceCall }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    idNumber: serviceCall?.idNumber || "",
    phone: serviceCall?.phone || "",
    email: serviceCall?.email || "",
    address: "",
    city: "",
  ...
  const steps = [
    { number: 1, title: "פרטי כלי" },
    { number: 2, title: "פרטי לקוח" },
    { number: 3, title: "פרטי נזק" },
    { number: 4, title: "מסמכים" },
    { number: 5, title: "תמונות" },
    { number: 6, title: "סיכום" },
  ];
  ...
  const handleSave = () => {
    console.log("שמירת קריאת שירות:", formData);
    onClose();
    setCurrentStep(1);
  };
