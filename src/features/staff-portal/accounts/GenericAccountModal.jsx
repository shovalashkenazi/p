...
const GenericAccountModal = ({ isOpen, onClose, account, accountType = "account" }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    // הרשאות
    canViewPrices: account?.canViewPrices || true,
    canPlaceOrders: account?.canPlaceOrders || true,
    canViewDocuments: account?.canViewDocuments || true,
  ...
  const handleSubmit = () => {
    console.log("שמירת חשבון:", formData);
    onClose();
  };
    ...
    <Modal isOpen={isOpen} onClose={onClose} size="6xl" scrollBehavior="inside">
      ...
      <ModalContent dir="rtl" maxH="90vh">
        <ModalHeader
          ...
          color={textColor}
        >
          {account ? "עריכת חשבון" : "יצירת חשבון חדש"}
        </ModalHeader>
            ...
            <TabPanels>
                ...
                >
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      placeholder="הוסף הערות נוספות על החשבון..."
                      borderRadius="lg"
                      bg={bgColor}
                      rows={10}
                    />
              ...
              <TabPanel p={6}>
                ...
                >
                  ...
                  <Text fontSize="sm" color={secondaryText} mb={4}>
                    ניהול משתמשים המשויכים לחשבון זה
                  </Text>
                  <Button
              ...
              <TabPanel p={6}>
                ...
                >
                  ...
                  <Text fontSize="sm" color={secondaryText} mb={4}>
                    רשימת הכלים והרכבים השייכים לחשבון
                  </Text>
                  <Button
                    leftIcon={<Plus size={18} />}
                    colorScheme="orange"
                  ...
                  <VStack spacing={6} align="stretch">
                    ...
                    <HStack justify="space-between" p={4} bg={bgColor} borderRadius="lg">
                      <Box>
                        ...
                        <Text fontSize="xs" color={secondaryText}>
                          האם החשבון יכול לצפות במחירי מוצרים
                        </Text>
                      </Box>
                      <Switch
                        colorScheme="orange"
                    ...
                    <HStack justify="space-between" p={4} bg={bgColor} borderRadius="lg">
                      <Box>
                        ...
                        <Text fontSize="xs" color={secondaryText}>
                          האם החשבון יכול לצפות במסמכים שלו
                        </Text>
                      </Box>
                      <Switch
                        colorScheme="orange"
              ...
              <TabPanel p={6}>
                ...
                >
                  ...
                  <Text fontSize="sm" color={secondaryText}>
                    היסטוריה מלאה של כל המסמכים והעסקאות עם החשבון
                  </Text>
                  {account && (
              ...
              <TabPanel p={6}>
                ...
                >
                  ...
                  <Text fontSize="sm" color={secondaryText} mb={4}>
                    מסמכים, תמונות וקבצים רלוונטיים לחשבון
                  </Text>
                  <Button
...
export default GenericAccountModal;
